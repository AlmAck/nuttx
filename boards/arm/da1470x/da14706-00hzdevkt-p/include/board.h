 ...
 * through a coupling capacitor.  Those inputs share their pads with P1.05
 * and P1.06, which come out of reset as digital pins with a pull resistor,
 * so both have to be put in analogue mode or they load the microphone
 * signal away.
 */
